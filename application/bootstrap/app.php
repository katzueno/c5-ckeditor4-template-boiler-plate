...
$assetList->register(
    ...
    'js/ckeditor4/vendor/plugins/templates/register.js'
);
...
if ($this->app->isInstalled()) {
    ...
    $editorPlugin->setKey('templates');
    $editorPlugin->setName(t('Templates'));
    $editorPlugin->requireAsset('javascript', 'editor/ckeditor4/templates');
